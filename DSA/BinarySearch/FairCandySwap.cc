 ...
 *            Output: [1,2]  ==>  alice need pass 1 candy to nik and similarly nik need pass 2 candy to alice
 ...
 *       aliceSum -x(removing from alice) + y(adding from nik) = nikSum -y(removing from nik) + x(adding from alice)
 ...
 *  Space Complexity  : Used map to store the element 0(1);
 ******************************************************************************************************************/
