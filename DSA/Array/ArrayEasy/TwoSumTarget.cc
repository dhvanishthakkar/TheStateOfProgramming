...
/*****************************************************************************************************
 *  WAP to add two numbers and it should be equal to given taget value, Return the both index
 *  
 *  Solution :
 *    We can approch this problem many ways but we will implement only 2 solution.
 *
 ...
 *                     Remaining value you need to find in the map if remainig target value
 *                     preset in the map then return the index number or move forward with other num.
 *
 *     2) Two Pointer Approch : (Binary Search Technique)
 ...
 *                    Add first element + last element and compare with taget, If possible target value is greater then actual target
 *                    then you need to decrement end pointer by 1, Similary if possible target value is less then actual target 
 *                    then increment the start pointer by 1. You need to do this untill you find exact atcual target or
 *                    Start <= end pointer. If you dont fine actual target then return -1.
 *
 *****************************************************************************************************/
...
int main()
{
	...
	// Result display and validations
	if (result1.size() == 2)
	...
	// Result display and validations
	if (result2.size() == 2)
		cout << "POINTER : FirstIndex : " << result2[0] << ", SecondIndex : " << result2[1] << endl;
    else
		cout << "There is no 2 values which has sum of target value in the Array:: " << target << endl;
